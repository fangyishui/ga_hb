...
public abstract class AbstractUnitConvert implements UnitConvert {
    ...
    public String convert(String value, String originUnit, String newUnit) {
        ...
        // 防护：SNMP 可能返回 "No such instance" 等非数字值，跳过转换
        BigDecimal wrappedValue;
        try {
            wrappedValue = new BigDecimal(value);
        } catch (NumberFormatException e) {
            log.warn("Unit convert failed, value [{}] is not a valid number, skip conversion", value);
            return value;
        }
